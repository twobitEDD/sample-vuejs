  ...
  theme: {
    glow: {
      styles: {
        ...
        "2xl": (baseColor) =>
          `0 25px 50px -12px rgba(${baseColor}, 1)`,
        outline: (baseColor) =>
          `0 0 0 3px rgba(${baseColor}, 0.5)`,
        none: "none",
      },
    },
    groupLevel: 10,
    ...
    extend: {
      ...
      boxShadow: {
        "dark-depth":
          "inset .2rem .2rem .5rem #0b0a0f, inset -.2rem -.2rem .5rem #38344c",
        "light-depth":
          "inset .2rem .2rem .5rem #b8bec7, inset -.2rem -.2rem .5rem #e2e5e9",
        "dark-level":
          ".3rem .3rem .6rem #0b0a0f, -.2rem -.2rem .5rem #38344c",
        "light-level":
          ".3rem .3rem .6rem #b8bec7, -.2rem -.2rem .5rem #e2e5e9",
      },
    },
    screens: {
      ss: "200px",
